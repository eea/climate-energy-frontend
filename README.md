...
[![Release pipeline](https://ci.eionet.europa.eu/buildStatus/icon?job=volto%2Fclimate-energy-frontend%2F2.20.0&build=last&subject=release%20v2.20.0%20pipeline)](https://ci.eionet.europa.eu/view/Github/job/volto/job/climate-energy-frontend/job/2.20.0/lastBuild/display/redirect/)
